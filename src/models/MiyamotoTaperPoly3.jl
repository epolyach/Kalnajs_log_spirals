...
# src/models/MiyamotoTaperPoly3.jl

"""
Miyamoto model with poly3 taper in circulation space for Kuzmin-Toomre disk with Plummer potential
Based on Miyamoto (1971) and Hunter (1992) formulations with poly3 taper T(v) = 1/2 + 3x/4 - x^3/4, x = v/v_0 
"""
module MiyamotoTaperPoly3
...
export MiyamotoTaperPoly3Model, create_miyamoto_taper_poly3_model, setup_model

# =============================================================================
# MODEL DEFINITION
# =============================================================================

struct MiyamotoTaperPoly3Model <: AbstractGalacticModel end
...
"""
    create_miyamoto_taper_poly3_model(config::KalnajsConfig) -> ModelResults

Create a Miyamoto model with poly3 taper in circulation space from configuration parameters.
"""
function create_miyamoto_taper_poly3_model(config)
    ...
    return setup_model(MiyamotoTaperPoly3Model, n_M, v_0; 
                       unit_mass=unit_mass, 
...
"""
    setup_model(::Type{MiyamotoTaperPoly3Model}, n_M::Int, v_0::Real; kwargs...) -> ModelResults
"""
function setup_model(::Type{MiyamotoTaperPoly3Model}, n_M::Int, v_0::Real; 
    ...
    if get(ENV, "PME_VERBOSE", "true") != "false"
        println("Setting up Miyamoto model with poly3 taper (n_M=$n_M, v_0=$v_0, selfgravity=$selfgravity)")
    end
    ...
    # New piecewise polynomial implementation: T(x) = 1/2 + 3x/4 - x^3/4, x = v/v_0
